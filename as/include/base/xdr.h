 ...
 * xdr.h
 *
 * Copyright (C) 2020-2024 Aerospike, Inc.
 *
...
void as_xdr_dc_state(struct as_info_cmd_args_s* args);
void as_xdr_get_filter(struct as_info_cmd_args_s* args);
void as_xdr_set_filter(struct as_info_cmd_args_s* args);
